...
int main(int argc, char **argv) {
  ...
  // TODO: Do not explicitly set device memory size to avoid messing the
  // aligned memory start workaround. In the genral case, we will need
  // to implement custom memory mapping to avoid misaligned memory
  // addresses between recording and replaying a kernel.
